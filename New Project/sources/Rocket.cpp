...
void Rocket::Shoot(const Point2D < double > &Start, const Vector2D < double > &Dir, const double &_Speed, const double &Len, const double &_R) {
...
Rocket::Rocket(const Point2D < double > &Start, const Vector2D < double > &Dir, const double &_Speed, const double &Len, const double &_R) {
	Shoot(Start, Dir, _Speed, Len, _R);
}
